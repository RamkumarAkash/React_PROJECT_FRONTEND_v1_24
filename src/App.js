...
import PetTable from "./views/Pet_table/Pet_index";
import ViewPet from "./views/Pet_details/Pet_view";
import CreatePetForm from "./views/Pet_details/Pet_createForm";
import EditPetForm from "./views/Pet_details/Pet_editForm";
import "./App.css";
        ...
        <SnackbarProvider maxSnack={1} autoHideDuration={2500}>
          ...
          >
            ...
            <Routes>
              ...
              <Route path="/Pets/edit/:id" element={<EditPetForm />}/>
              <Route path="/Pets/view/:id" element={<ViewPet />} />
              <Route path="/Pets/create" element={<CreatePetForm />} />
            </Routes>
          </main>
        </SnackbarProvider>
      </BrowserRouter>
